                ...
                <div className="items-center gap-x-12 lg:flex">
                    ...
                    <div className="max-w-xl mt-6 md:mt-0 lg:max-w-2xl">
                        ...
                        <p className="mt-3 text-gray-600">
                            Atlas Forge, a software development company, helps to digitize businesses by focusing on client’s business challenges and needs. We value close, transparent cooperation and encourage our clients to participate actively in the project development life cycle.
                        </p>
                        <NavLink
                            href="/get-started"
